                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-users--id-">DELETE api/users/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-users-bulk-delete">
                                <a href="#endpoints-POSTapi-users-bulk-delete">POST api/users/bulk-delete</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-users-bulk-status">
                                <a href="#endpoints-PATCHapi-users-bulk-status">PATCH api/users/bulk-status</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-posts--id-">DELETE api/posts/{id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-posts-bulk-delete">
                                <a href="#endpoints-POSTapi-posts-bulk-delete">POST api/posts/bulk-delete</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-posts-bulk-status">
                                <a href="#endpoints-PATCHapi-posts-bulk-status">PATCH api/posts/bulk-status</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>The ID of the user. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-users-bulk-delete">POST api/users/bulk-delete</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="POSTapi-users-bulk-delete"
               value="banned"
               data-component="body">
    <br>
<p>This field is required when <code>action</code> is <code>update_status</code>. Example: <code>banned</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>active</code></li> <li><code>inactive</code></li> <li><code>banned</code></li></ul>
        </div>
        </form>

                    <h2 id="endpoints-PATCHapi-users-bulk-status">PATCH api/users/bulk-status</h2>
...
<p>The ID of the post. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-posts-bulk-delete">POST api/posts/bulk-delete</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="POSTapi-posts-bulk-delete"
               value="published"
               data-component="body">
    <br>
<p>This field is required when <code>action</code> is <code>update_status</code>. Example: <code>published</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>draft</code></li> <li><code>published</code></li> <li><code>archived</code></li></ul>
        </div>
        </form>

                    <h2 id="endpoints-PATCHapi-posts-bulk-status">PATCH api/posts/bulk-status</h2>
