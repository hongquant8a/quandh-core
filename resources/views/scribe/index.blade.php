...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-02-21T11:53:00"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-21T11:53:00</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "file=@/tmp/php6vlm9hkkch7m3tfgIqw" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'file',
                'contents' =&gt; fopen('/tmp/php6vlm9hkkch7m3tfgIqw', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>File Excel (xlsx, xls, csv). Cột theo chuẩn export. Example: <code>/tmp/php6vlm9hkkch7m3tfgIqw</code></p>
        </div>
        </form>
    ...
    &quot;data&quot;: [
        {
            ...
            &quot;created_by&quot;: &quot;N/A&quot;,
            &quot;updated_by&quot;: &quot;N/A&quot;,
            &quot;created_at&quot;: &quot;21/02/2026 11:53:00&quot;,
            &quot;updated_at&quot;: &quot;21/02/2026 11:53:00&quot;
        },
        {
            &quot;id&quot;: 22,
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: {
        &quot;id&quot;: 1,
        &quot;title&quot;: &quot;Atque quos et sit quia ab.&quot;,
        &quot;slug&quot;: &quot;atque-quos-et-sit-quia-ab&quot;,
        &quot;content&quot;: &quot;Recusandae eaque omnis odio facere. Quidem nihil aliquid eum eius officia esse. Ipsum sunt modi aspernatur nemo. Molestiae vel ut quia ipsa.\n\nSit qui dicta aliquid est laudantium. Inventore et odio sunt. Nemo facilis corrupti facilis. Amet deleniti rerum libero animi.\n\nBeatae sunt itaque cumque totam facilis iusto quasi voluptatem. Nesciunt omnis necessitatibus illo. Iure amet perferendis delectus nulla eum. Officiis suscipit eius earum dolorum asperiores. Quia autem qui animi.&quot;,
        &quot;status&quot;: &quot;draft&quot;,
        &quot;view_count&quot;: 0,
        &quot;categories&quot;: [
            {
                ...
                &quot;slug&quot;: &quot;giao-duc&quot;,
                &quot;description&quot;: &quot;Nisi adipisci hic quisquam sed.&quot;,
                &quot;status&quot;: &quot;inactive&quot;,
                &quot;sort_order&quot;: 5,
                &quot;parent_id&quot;: null,
                &quot;depth&quot;: 0,
                &quot;created_by&quot;: &quot;Amie Boyer&quot;,
                &quot;updated_by&quot;: &quot;Amie Boyer&quot;,
                &quot;created_at&quot;: &quot;21/02/2026 11:52:47&quot;,
                &quot;updated_at&quot;: &quot;21/02/2026 11:52:48&quot;
            }
        ],
        &quot;attachments&quot;: [],
        &quot;created_by&quot;: &quot;Dr. Jerrold Predovic&quot;,
        &quot;updated_by&quot;: &quot;Ms. Caterina Abernathy IV&quot;,
        &quot;created_at&quot;: &quot;21/02/2026 11:52:48&quot;,
        &quot;updated_at&quot;: &quot;21/02/2026 11:52:48&quot;
    },
    &quot;success&quot;: &quot;true&quot;
}</code>
...
<div class="bash-example">
    ...
    --form "status=draft"\
    --form "category_ids[]=1"\
    --form "images[]=@/tmp/phpvk6o5qdl1c2tb2FP4sT" \
    --form "images[]=@/tmp/phph9hsvh24adfq2o0qGg7" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'images[]',
                'contents' =&gt; fopen('/tmp/phpvk6o5qdl1c2tb2FP4sT', 'r')
            ],
            [
                'name' =&gt; 'images[]',
                'contents' =&gt; fopen('/tmp/phph9hsvh24adfq2o0qGg7', 'r')
            ],
        ],
    ]
);
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Ảnh đính kèm (jpeg/png/gif/webp, tối đa 10 ảnh, mỗi ảnh ≤ 5MB). Example: <code>/tmp/phph9hsvh24adfq2o0qGg7</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "images[]=@/tmp/php6bvp9nn9tjtn79n4xYt" \
    --form "images[]=@/tmp/php232vemqevlmj9w8sQCh" </code></pre></div>
...
$response = $client-&gt;put(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'images[]',
                'contents' =&gt; fopen('/tmp/php6bvp9nn9tjtn79n4xYt', 'r')
            ],
            [
                'name' =&gt; 'images[]',
                'contents' =&gt; fopen('/tmp/php232vemqevlmj9w8sQCh', 'r')
            ],
        ],
    ]
);
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Ảnh mới (append). Example: <code>/tmp/php232vemqevlmj9w8sQCh</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --form "category_ids[]=architecto"\
    --form "remove_attachment_ids[]=architecto"\
    --form "images[]=@/tmp/phponm9d2qacinv2XGGgTU" \
    --form "images[]=@/tmp/php88to635f4jb9bVXivfn" </code></pre></div>
...
$response = $client-&gt;patch(
    ...
    [
        ...
        'multipart' =&gt; [
            ...
            [
                'name' =&gt; 'images[]',
                'contents' =&gt; fopen('/tmp/phponm9d2qacinv2XGGgTU', 'r')
            ],
            [
                'name' =&gt; 'images[]',
                'contents' =&gt; fopen('/tmp/php88to635f4jb9bVXivfn', 'r')
            ],
        ],
    ]
);
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Ảnh mới (append). Example: <code>/tmp/php88to635f4jb9bVXivfn</code></p>
        </div>
        </form>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="from_date"                data-endpoint="GETapi-log-activities-export"
               value="2026-02-21T11:53:02"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-21T11:53:02</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>to_date</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpkbvr2ea9sa2cdDriqnG" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'file',
                'contents' =&gt; fopen('/tmp/phpkbvr2ea9sa2cdDriqnG', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>File excel (xlsx, xls, csv). Cột: name, slug, description, status. Example: <code>/tmp/phpkbvr2ea9sa2cdDriqnG</code></p>
        </div>
        </form>
    ...
    &quot;data&quot;: [
        {
            ...
            &quot;created_by&quot;: &quot;N/A&quot;,
            &quot;updated_by&quot;: &quot;N/A&quot;,
            &quot;created_at&quot;: &quot;11:52:49 21/02/2026&quot;,
            &quot;updated_at&quot;: &quot;11:52:49 21/02/2026&quot;
        },
        {
            &quot;id&quot;: 1,
            &quot;name&quot;: &quot;Default&quot;,
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="from_date"                data-endpoint="GETapi-permissions-export"
               value="2026-02-21T11:53:01"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-21T11:53:01</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>to_date</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpqcnmk46p2osh09Xe3ge" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'file',
                'contents' =&gt; fopen('/tmp/phpqcnmk46p2osh09Xe3ge', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>File excel (xlsx, xls, csv). Cột: name, guard_name, description, sort_order, parent_id. Example: <code>/tmp/phpqcnmk46p2osh09Xe3ge</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpjqq8ruukk4odauEono4" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'file',
                'contents' =&gt; fopen('/tmp/phpjqq8ruukk4odauEono4', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>File excel (xlsx, xls, csv). Cột: name, guard_name, organization_id. Example: <code>/tmp/phpjqq8ruukk4odauEono4</code></p>
        </div>
        </form>
    ...
    &quot;data&quot;: [
        {
            ...
            &quot;guard_name&quot;: &quot;web&quot;,
            &quot;organization_id&quot;: 1,
            &quot;created_at&quot;: &quot;11:52:51 21/02/2026&quot;,
            &quot;updated_at&quot;: &quot;11:52:51 21/02/2026&quot;
        },
        {
            &quot;id&quot;: 1,
            &quot;name&quot;: &quot;Super Admin&quot;,
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="2026-02-21T11:52:59"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2026-02-21T11:52:59</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>to_date</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpajdsqav0bnmacwkNUAB" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'file',
                'contents' =&gt; fopen('/tmp/phpajdsqav0bnmacwkNUAB', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>File excel (xlsx, xls, csv). Cột: name, email, password, status. Example: <code>/tmp/phpajdsqav0bnmacwkNUAB</code></p>
        </div>
        </form>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;data&quot;: [
        ...
        },
        {
            &quot;id&quot;: 12,
            &quot;name&quot;: &quot;Derrick Kunde&quot;,
            &quot;email&quot;: &quot;ecollier@example.org&quot;,
            &quot;user_name&quot;: &quot;friedrich.jacobson&quot;,
            &quot;status&quot;: &quot;active&quot;,
            &quot;created_by&quot;: &quot;N/A&quot;,
            &quot;updated_by&quot;: &quot;N/A&quot;,
            &quot;created_at&quot;: &quot;21/02/2026 11:53:00&quot;,
...
<div class="bash-example">
    ...
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "file=@/tmp/phpbjj5d1gnlpr3de7uvlv" </code></pre></div>
...
$response = $client-&gt;post(
    ...
    [
        ...
        'multipart' =&gt; [
            [
                'name' =&gt; 'file',
                'contents' =&gt; fopen('/tmp/phpbjj5d1gnlpr3de7uvlv', 'r')
            ],
        ],
    ]
);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>File Excel (xlsx, xls, csv). Cột: name, slug, description, status, sort_order, parent_slug. Example: <code>/tmp/phpbjj5d1gnlpr3de7uvlv</code></p>
        </div>
        </form>
    ...
    &quot;data&quot;: [
        {
            ...
            &quot;created_by&quot;: &quot;N/A&quot;,
            &quot;updated_by&quot;: &quot;N/A&quot;,
            &quot;created_at&quot;: &quot;21/02/2026 11:53:01&quot;,
            &quot;updated_at&quot;: &quot;21/02/2026 11:53:01&quot;
        },
        {
            &quot;id&quot;: 21,
            &quot;name&quot;: &quot;Aut Ab&quot;,
