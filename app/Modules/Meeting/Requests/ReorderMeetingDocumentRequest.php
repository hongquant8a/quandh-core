...
class ReorderMeetingDocumentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.id' => 'required|integer|exists:meeting_documents,id',
    ...
    public function bodyParameters(): array
    {
        return [
            'items' => [
                'description' => 'Danh sách cặp id và sort_order để sắp xếp lại tài liệu họp.',
                'example' => [
                    ['id' => 1, 'sort_order' => 1],
                    ['id' => 2, 'sort_order' => 2],
                ],
