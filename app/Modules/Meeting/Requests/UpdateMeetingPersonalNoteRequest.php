...
class UpdateMeetingPersonalNoteRequest extends FormRequest
{
    ...
    {
        return [
            'content' => ['description' => 'Nội dung ghi chú cập nhật.', 'example' => 'Bổ sung nội dung cần lưu ý'],
            'sort_order' => ['description' => 'Thứ tự hiển thị.', 'example' => 2],
        ];
    }
}
