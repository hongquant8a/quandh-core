...
class ReorderMeetingDiscussionRegistrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.id' => 'required|integer|exists:meeting_discussion_registrations,id',
    ...
    public function bodyParameters(): array
    {
        return [
            'items' => [
                'description' => 'Danh sách cặp id và sort_order để sắp xếp đăng ký thảo luận/chất vấn.',
                'example' => [
                    ['id' => 1, 'sort_order' => 1],
                    ['id' => 2, 'sort_order' => 2],
                ],
