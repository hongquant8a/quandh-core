...
class ReorderMeetingPersonalNoteAttachmentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.id' => 'required|integer|exists:meeting_personal_note_attachments,id',
    ...
    public function bodyParameters(): array
    {
        return [
            'items' => [
                'description' => 'Danh sách cặp id và sort_order để sắp xếp file ghi chú cá nhân.',
                'example' => [
                    ['id' => 1, 'sort_order' => 1],
                    ['id' => 2, 'sort_order' => 2],
                ],
